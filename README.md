...
The GitHub release includes `PhoneSense-Android.apk`, the latest Android 0.1.18 build. It has a minimum API 23, targets API 36, and passes the complete isolated test suite on API 23, 28, a physical API 29 Pixel, API 31, and API 36. It is debug-signed for direct testing and sideloading, not Play Store distribution. Android may ask you to allow installation from the browser or file manager used to open it.
